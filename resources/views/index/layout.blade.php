...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                @auth
                <li class="nav-item">
                    <a href="{{ url('/dashboard') }}" class="nav-link nav-link-2">Dashboard</a>
                </li>
                @else
                <li class="nav-item">
                    <a href="{{ route('login') }}" class="nav-link nav-link-3">Log in</a>
                </li>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="{{URL::to('/');}}/img/hero.jpg">
        <form action="{{route('index')}}" method="GET" class="d-flex tm-search-form">
        ...
        <div class="container-fluid tm-container-small">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 px-5 mb-5">
                    <h3 class="tm-text-primary mb-4 tm-footer-title">Template Credits</h3>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-7 col-12 px-5 mb-3">
                    Shopify Code Challenge Front End
                </div>
